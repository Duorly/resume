  ...
  <section id="menu_projects" class="py-20 px-4">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <UiSpotlightCard v-for="(project, index) in projects" :key="index"
          ...
          <div class="flex flex-col h-full">
            ...
            <div v-if="project.image.length <= 0"
              class="mb-6 relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-800 to-slate-900 aspect-video flex items-center justify-center">
            ...
            <UCarousel v-else v-slot="{ item }" :items="project?.image" class="w-full mx-auto mb-6"
              :autoplay="{ delay: 2000 }" loop>
              <NuxtImg :src="item" :alt="project.title + ' screenshot ' + (index + 1)" class="rounded-lg" loading="lazy"
                format="webp" quality="80" width="1280" height="720" />
            </UCarousel>
